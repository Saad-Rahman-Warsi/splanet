  ...
  return(
    <Table striped bordered hover>
              <thead>
                <tr>
                  <th>S.No </th>
                  <th>Facility Name for the Learning Session</th>
                  <th>Date</th>
                  <th>Time</th>
                </tr>
              </thead>
...
/*******************************************************************************************/
function BookLearnStep1(props) {
  return (
    <div>
      <ShowProgress label="(Booking Experiment Learning Session) Step 1 of 2 : Enter Personal Information"/>
      <Row>
      <Col xs={2}></Col>
      <Col xs={8}>
...
/*******************************************************************************************/
function BookLearnStep2(props) {
  return (
    <div style={{textAlign: "left"}}>
      <Container fluid>
        <Row> <ShowProgress label="(Booking Experiment Learning Session) Step 2 of 2 : Select the facility that you wish to learn"/> </Row>
        <Row>
          ...
          <Col xs={6}>  
            <ShowBookLearn rflag={props.rflag} setRFlag={props.setRFlag}/>
          </Col>
        </Row>
...
/*******************************************************************************************/
function BookLearnStep3(props){
  return(
  <div>
    <Row> <ShowProgress label="(Booking Experiment Learning Session) Order Confirmation"/> </Row>
    <Row>
    <Col xs={3}> </Col>
    <Col>
    <h6 style={{textAlign: 'left'}}> Your order to book the Experiment Learning Sessions is confirmed.
        Order No is 327154. Order Details are as given below - </h6>
...
/*******************************************************************************************/
function BookLearn(props) {
  return(
    <>
    {orderState==1 && <BookLearnStep1 rflag={props.rflag} setRFlag={props.setRFlag}/>}
    {orderState==2 && <BookLearnStep2 rflag={props.rflag} setRFlag={props.setRFlag}/>}
    {orderState==3 && <BookLearnStep3 rflag={props.rflag} setRFlag={props.setRFlag}/>}
    </>
  );
}
